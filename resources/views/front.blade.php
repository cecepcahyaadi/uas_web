...
<div class="center-container">
			...
			<div class="w3_agile_header">
						<div class="w3_agileits_logo" style="width: 1000px; padding-bottom: 20px;font-size: 70px">
                             <center>
                            <a class="brand" href=""><img class="img-circle" src="images/WELCOME.png" style="width: 250px"></a>
                            </center>
							</div>
							<div class="w3_menu">
      ...
      <nav class="navbar navbar-expand-md navbar-blue bg-light sticky-top ">
            <div class="container-fluid ">
                        ...
                        <a class="navbar" href="{{ url('/') }}">
                            <img class="img-circle" src="images/WELCOME.png" style="width: 100px; height: 50px">
                        </a>
    ...
    <div class="copyright">
	           <p>© 2019 WELCOME SHOP. All rights reserved | Design by Cecep Cahya Adi Wiguna</p>
    </div>
